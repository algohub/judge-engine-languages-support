...
public:
    ...
    LinkedListNode<E>(): next(nullptr) { }   // for dummy node
    LinkedListNode<E>(E x) : value(x), next(nullptr) { }
    LinkedListNode<E>(E x, std::shared_ptr<LinkedListNode<E>> _next) : value(x), next(_next) { }
...
struct BinaryTreeNode {
    ...
    BinaryTreeNode<E>(): left(nullptr), right(nullptr) { }  // for dummy node
    BinaryTreeNode<E>(E x) : value(x), left(nullptr), right(nullptr) { }
    BinaryTreeNode<E>(E x, std::shared_ptr<BinaryTreeNode<E>> _left, std::shared_ptr<BinaryTreeNode<E>> _right) :
